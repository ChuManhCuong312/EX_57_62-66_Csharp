...
//Cách 2: Sử dụng StreamReader
class EX62_2
{
    public static Dictionary<string, object> ReadJsonFileToDictionaryAlternative(string fileName)
    {
        try
        {
            // Sử dụng StreamReader để đọc tệp JSON
    ...
    static void Main(string[] args)
    {
        ...
        Dictionary<string, object> result = ReadJsonFileToDictionaryAlternative(fileName);
